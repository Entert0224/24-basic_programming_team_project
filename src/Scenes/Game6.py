...
class Game6(Scene) :
    ...
    #속담이 있는 파일의 내용을 모두 불러온다.
    @classmethod
    def LoadQuizFile(cls) :
        cls.shuffled_quiz_list.clear()
        with open("assets/texts/proverb.txt", 'r', encoding='utf-8') as file:
    ...
    def Setup(cls) :
        if cls.is_first_game :
            ...
            cls.desc_panal = Sprite("assets/images/Desc_talk_with_body.png",Vec2(SCREEN_WIDTH/2, SCREEN_HEIGHT/2), layer=13)
            ...
            cls.desc_panal = Sprite("assets/images/Desc_talk_with_body.png",Vec2(SCREEN_WIDTH/2, SCREEN_HEIGHT/2), layer=13, visible = False)
        ...
        #타이머와 퀴즈 텍스트
        cls.timer_text = Text("180.00",Vec2(SCREEN_WIDTH/2 - 340, SCREEN_HEIGHT/2 - 270), size=45, fontpath="assets/fonts/H2HDRM.TTF") 
